...
for (iinput in 1 : length(comb_list)){
  ...
  vformula4[nformula4] = paste(voutput," ~ ", '1+',vinput[comb_list[[iinput]]],'+(1|Subject)')
}
  ...
  operator_list=0
    ...
    if (iterm == 2){
      for (iinput in 1 : dim(perm_list)[1]){
        ...
        vformula4[nformula4] = paste(voutput," ~ ", '1+',c_vinput[1],operator_list[1],c_vinput[2],'+(1|Subject)')
      }
    }
    if (iterm == 3){
      for (iinput in 1 : dim(perm_list)[1]){
        nformula4 = nformula4 + 1
        c_vinput = vinput[perm_list[iinput,]]
        vformula4[nformula4] = paste(voutput," ~ ", '1+',c_vinput[1],operator_list[1],c_vinput[2],operator_list[2],c_vinput[3],'+(1|Subject)')
      }
    }
    if (iterm == 4){
      for (iinput in 1 : dim(perm_list)[1]){
        nformula4 = nformula4 + 1
        c_vinput = vinput[perm_list[iinput,]]
        vformula4[nformula4] = paste(voutput," ~ ", '1+',c_vinput[1],operator_list[1],c_vinput[2],operator_list[2],c_vinput[3],operator_list[3],c_vinput[4],'+(1|Subject)')
      }
    }
    if (iterm == 5){
      for (iinput in 1 : dim(perm_list)[1]){
        nformula4 = nformula4 + 1
        c_vinput = vinput[perm_list[iinput,]]
        vformula4[nformula4] = paste(voutput," ~ ", '1+',c_vinput[1],operator_list[1],c_vinput[2],operator_list[2],c_vinput[3],operator_list[3],c_vinput[4],operator_list[4],c_vinput[5],'+(1|Subject)')
      }
    }
